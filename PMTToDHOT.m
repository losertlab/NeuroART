...
%     calibrationFile = load(['.' filesep 'calibration' filesep '20230118_PMTSLMCalib_x7635y9420_3x.mat']); % for 3x zoom factor
    ...
    PMT2Cam = load(['.' filesep 'calibration' filesep '20230206_PMTCamCalib.mat']); % PMT to Camera calibration file
    Cam2SLM = load(['.' filesep 'calibration' filesep '20230206_CamSLMCalib.mat']); % Camera to SLM calibration file
